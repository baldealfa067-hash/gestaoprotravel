...
BEFORE INSERT OR UPDATE OF continente_origem, continente_destino, classe, custo ON public.bilhetes
...
DROP TRIGGER IF EXISTS trg_sync_reserva_on_bilhete_emitido ON public.bilhetes;
CREATE TRIGGER trg_sync_reserva_on_bilhete_emitido
...
BEFORE INSERT OR UPDATE OF saldo ON public.companhias_aereas
